const simpleSort = function(arr, key, order = "asc") {
  ...
  const arrayWalk = function(array, funcname, userdata) {
  ...
  const arrayWalkRecursive = function(array, funcname, userdata) {
    if (!array || typeof array !== 'object') {
      return false;
    }
  ...
  const arrayPad = function(input, padSize, padValue) {
    var pad = [];
    var newArray = [];
    var newLength;
    var diff = 0;
  ...
  const arrayChangeKeyCase = function(array, cs) {
    var caseFnc;
    var key;
    var tmpArr = {};
  ...
  const arrayIntersect = function(arr1) {
    var retArr = {};
  ...
  const arrayDiffAssoc = function(arr1) {
    var retArr = {};
    var argl = arguments.length;
    var k1 = '';
    var i = 1;
  ...
  const arrayDiffKey = function(arr1) {
    var argl = arguments.length;
    var retArr = {};
    var k1 = '';
    var i = 1;
  ...
  const arrayDiffUassoc = function(arr1) {
    var retArr = {};
  ...
  const arrayDiffUkey = function(arr1) {
    var retArr = {};
    var arglm1 = arguments.length - 1;
    var cb = arguments[arglm1];
    var k1 = '';
  ...
  const arrayIntersectAssoc = function(arr1) {
    var retArr = {};
    var argl = arguments.length;
    var arglm1 = argl - 1;
    var k1 = '';
  ...
  const arrayIntersectKey = function(arr1) {
    var retArr = {};
    var argl = arguments.length;
    var arglm1 = argl - 1;
    var k1 = '';
  ...
  const arrayIntersectUassoc = function(arr1) {
    var retArr = {};
    var arglm1 = arguments.length - 1;
    var arglm2 = arglm1 - 1;
    var cb = arguments[arglm1];
  ...
  const arrayIntersectUkey = function(arr1) {
    var retArr = {};
    var arglm1 = arguments.length - 1;
    var arglm2 = arglm1 - 1;
    var cb = arguments[arglm1];
  ...
  const arrayKeys = function(input, searchValue, argStrict) {
  ...
  const arrayMultisort = function(arr) {
    var g;
    var i;
    var j;
    var k;
  ...
  const arrayFill = function(startIndex, num, mixedVal) {
    var key;
    var tmpArr = {};
  ...
  const arrayFillKeys = function(keys, value) {
    var retObj = {};
    var key = '';
  ...
  const arrayRand = function(array, num) {
  ...
  const arrayChunk = function(input, size, preserveKeys) {
    var x;
    var p = '';
    var i = 0;
    var c = -1;
  ...
  const arrayCountValues = function(array) {
    var tmpArr = {};
    var key = '';
    var t = '';
  ...
  const arrayFlip = function(trans) {
    var key;
    var tmpArr = {};
  ...
  const arrayMergeRecursive = function(arr1, arr2) {
    var idx = '';
  ...
  const arrayProduct = function(input) {
    var idx = 0;
    var product = 1;
    var il = 0;
  ...
  const arrayReplace = function(arr) {
    var retObj = {};
    var i = 0;
    var p = '';
    var argl = arguments.length;
  ...
  const arrayReplaceRecursive = function(arr) {
    var i = 0;
    var p = '';
    var argl = arguments.length;
    var retObj;
  ...
  const array_reverse = function(array, preserveKeys) {
  ...
  const arraySearch = function(needle, haystack, argStrict) {
    var strict = !!argStrict;
    var key = '';
  ...
  const arrayShift = function(inputArr) {
